$(document).ready(function () {
  try {
    ...
    $.each(content_types_user_permissions, function (type, permissions) {
      ...
      if (permissions.create) {
        ...
        if (content_type) {
          $("#drupalgap_page_content_add_list").append($("<li></li>", {
            "html": "<a href='node_edit.html' id='" + content_type.type + "'>" + content_type.name + "</a>"
          }));
        }
      }
    });
